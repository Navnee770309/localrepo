...
export class TicketService {
  private apiUrl = 'http://localhost:8089/api/tickets'; // Base URL for Ticket APIs
  private apiCustomerProductsUrl = 'http://localhost:8087/api/customers'; // For customer/product validation
